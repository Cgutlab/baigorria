...
<main>
	<div class="container fullwidth">
		...
		<div class="row">
			<div class="col s12">
				{!!Form::model($var, ['route'=>['certificados.update', $var->id], 'method'=>'PUT', 'files' => true])!!}
				<div class="row">
					{{--
				...
				<div class="row">
					<div class="file-field input-field col s8">
						...
						<div class="file-path-wrapper">
							{!! Form::text('',$var->ficha, ['class'=>'file-path validate', 'required']) !!}
						</div>
					</div>
				...
				@if($var->seccion == 'home')
					<div class="row">
						<div class="input-field col s12">
							...
							{!!Form::text('video',$var->video, ['class'=>'validate', 'required'])!!}
							<b>Debes colocar solo el código del video (marcado en rojo)<br>Ejemplo: </b>
