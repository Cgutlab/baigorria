			...
			<div class="col s12">
				...
				<div class="row">
					<div class="input-field col s4">
						...
						{!!Form::textarea('texto2_es',null, ['class'=>'validate', 'cols'=>'74', 'rows'=>'5'])!!}
					</div>
					<div class="input-field col s4">
						<div>{!!Form::label('Texto 2 English')!!}</div>
						{!!Form::textarea('texto2_en',null, ['class'=>'validate', 'cols'=>'74', 'rows'=>'5'])!!}
					</div>
					<div class="input-field col s4">
						<div>{!!Form::label('Texto 2 Portugues')!!}</div>
						{!!Form::textarea('texto2_br',null, ['class'=>'validate', 'cols'=>'74', 'rows'=>'5'])!!}
					</div>
				</div>
				@endif
